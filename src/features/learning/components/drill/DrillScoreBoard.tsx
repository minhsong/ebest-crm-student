...
function DrillScoreHudInner({ score, streak }: Props) {
...
/** @deprecated alias — dùng DrillScoreHud */
export const DrillScoreBoard = memo(DrillScoreHudInner);
export const DrillScoreHud = memo(DrillScoreHudInner);
